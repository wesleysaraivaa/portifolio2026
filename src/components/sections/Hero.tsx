  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="hidden md:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-[#a1a1aa] hover:text-purple-400 transition-colors duration-200 z-10"
      >
